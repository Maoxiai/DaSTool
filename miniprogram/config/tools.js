...
const TOOLS = [
  ...
  { path: '/pages/my_module/huangli/index', name: '黄历节气', des: '农历 · 节气 · 干支 · 生肖', icon: '📅', typeId: 3, typeName: '信息查询', sort: 27, type: 'huangli' },
  { path: '/pages/my_module/holiday/index', name: '法定节假日', des: '放假安排 · 调休 · 补班', icon: '🎉', typeId: 3, typeName: '信息查询', sort: 25, type: 'holiday' },
  { path: '/pages/my_module/express/index', name: '快递查询', des: '单号识别 · 快递公司', icon: '📦', typeId: 3, typeName: '信息查询', sort: 24, type: 'express' },
  { path: '/pages/my_module/train/index', name: '车次规则', des: '字母等级 · 速度 · 运行范围', icon: '🚄', typeId: 3, typeName: '信息查询', sort: 23, type: 'train' },
  { path: '/pages/my_module/admin_code/index', name: '行政区划代码', des: '省市区代码解析', icon: '🗺️', typeId: 3, typeName: '信息查询', sort: 21, type: 'admin_code' },
  { path: '/pages/my_module/plate/index', name: '车牌归属', des: '省份 · 城市归属', icon: '🚗', typeId: 3, typeName: '信息查询', sort: 20, type: 'plate' },
  // 常用工具
  ...
  { path: '/pages/my_module/randomNum/randomNum', name: '随机乐园', des: '随机数 · 骰子 · 硬币 · 抽取', icon: '🎲', typeId: 4, typeName: '常用工具', sort: 20, type: 'randomNum' },
